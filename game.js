...
(() => {
  ...
  const BIOME_ENEMIES = [
    // 🌿 みどりの楽園
    [["マンドラゴラ","🌱"],["どくチョウ","🦋"],["かぶとオーガ","🪲"],["サボテンマン","🌵"],["フラワーレイス","🌹"],["はなかっぱ","🌺"],["みどりへび","🐍"]],
    // ☁️ あおぞらの底
    [["てんしどり","🦢"],["ハーピー","🦜"],["くじゃく将","🦚"],["フラミンゴ兵","🦩"],["らいちょう","🐓"],["はやぶさ","🦆"],["かみなりどり","🐦"]],
    // 🔮 むらさきの霧
    [["ファントム","🦠"],["うずまきのぬし","🌀"],["しんかいイカ","🦑"],["エイリアン","👽"],["まようピエロ","🤡"],["きりの魔女","🧙"],["むらさきクラゲ","🎐"]],
    // 🌟 こがねの花園
    [["おうごんアリ","🐜"],["ひまわり魔","🌻"],["こがねバッタ","🦗"],["はなのせい","🌼"],["つぼマミック","🏺"],["こがねチョウ","🦋"],["おうごんバチ","🐝"]],
    // 🔥 あかい奈落
    [["マグマゴーレム","🌋"],["ボムへい","🧨"],["サラマンダー","🦎"],["かえんバード","🦃"],["ようがんりゅう","🐲"],["ひのたま","🔥"],["あかオニ","👹"]],
    // ✨ ほしぞらの間
    [["せいざのぬし","🪐"],["つきのこ","🌙"],["ながれぼし","🌠"],["スターラビ","⭐"],["UFOへい","🛸"],["ほうきぼし","💫"],["げっこう兵","🌝"]],
    // ❄️ こおりの洞
    [["こおりの精","🧊"],["ゆきうさぎ","🐇"],["セイウチ","🦭"],["こおりペンギン","🐧"],["しろくま兵","🐻"]],
    // 🌊 みなそこ
    [["ふかうお","🐟"],["でんきうお","🐠"],["カイダコ","🐚"],["シャチ","🐬"],["メガロドン","🦈"]],
    // 🪨 がんせきの層
    [["いわむし","🐛"],["がんせきうし","🐂"],["どうくつイノシシ","🐗"],["ようがんガニ","🦞"],["こうもり群","🦇"]],
    // 🍂 かれ葉の森
    [["もくれい","🌳"],["どんぐり兵","🌰"],["つたおとこ","🍂"],["くわがた","🪲"],["やまどり","🦃"]],
    // 🌑 やみの淵
    [["やみゴースト","👻"],["くろりゅう","🐉"],["まおうのしもべ","👹"],["やみの魔女","🧙"],["くろうさぎ","🐇"]],
    // 💠 けっしょう界
    [["クリスタル兵","💠"],["プリズム","🔷"],["すいしょうがめ","🐢"],["ひかりの精","✨"],["けっしょうりゅう","🐲"]],
  ];
  ...
  const BIOMES = [
    ...
    { name: "こおりの洞",   emoji: "❄️", wall: [190, 40, 55], cave: [195, 55, 72], bright: true },
    { name: "みなそこ",     emoji: "🌊", wall: [198, 55, 30], cave: [202, 62, 18] },
    { name: "がんせきの層", emoji: "🪨", wall: [26, 16, 34], cave: [26, 12, 16] },
    { name: "かれ葉の森",   emoji: "🍂", wall: [30, 52, 30], cave: [28, 46, 15] },
    { name: "やみの淵",     emoji: "🌑", wall: [252, 22, 16], cave: [250, 26, 8] },
    { name: "けっしょう界", emoji: "💠", wall: [176, 55, 44], cave: [184, 60, 28] },
  ];
  function biomeFor(r) {
